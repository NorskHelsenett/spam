	...
	r.Group(func(r chi.Router) {
		...
		r.Route("/api", func(api chi.Router) {
			if authService != nil {
				...
				api.Get("/admin/providers", uiapi.AdminProvidersListHandler(db, authService, providerStore))
				api.Post("/admin/providers", uiapi.AdminProvidersCreateHandler(db, authService, providerStore))
				api.Patch("/admin/providers/{id}", uiapi.AdminProvidersUpdateHandler(db, authService, providerStore))
				api.Post("/admin/providers/{id}/rotate", uiapi.AdminProvidersRotateHandler(db, authService, providerStore))
				api.Delete("/admin/providers/{id}", uiapi.AdminProvidersDeleteHandler(db, authService, providerStore))
